# -*- coding: utf-8 -*-
#
# pattern_manager documentation build configuration file, created by
...
import sys
import os
# auto version number from catkin
...
htmlhelp_basename = 'pattern_managerdoc'
...
latex_documents = [
    (master_doc, 'pattern_manager.tex', u'pattern\\_manager Documentation',
...
man_pages = [
    (master_doc, 'pattern_manager', u'pattern_manager Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pattern_manager', u'pattern_manager Documentation',
     author, 'pattern_manager', 'One line description of project.',
     'Miscellaneous'),
]
